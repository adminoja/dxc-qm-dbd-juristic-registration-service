...
@EnableJpaRepositories(
    entityManagerFactoryRef = Db01DataSourceConfig.DATASOURCE_BEAN_NAME+"EntityManagerFactory", 
    transactionManagerRef = Db01DataSourceConfig.DATASOURCE_BEAN_NAME+"TransactionManager"
)
public class Db01DataSourceConfig {
	// Configuration Required
	public final static String DATASOURCE_BEAN_NAME = "db01";
	public final static String DATASOURCE_PROPERTIES_NAME = "db-01";
	// Derived values
	public final static String DATASOURCE_PROPERTIES = "app.datasource."+DATASOURCE_PROPERTIES_NAME;
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
    	...
    	if(dataSource!=null)
    	{
    		...
    		log.info("{}HikariDataSource.getMaximumPoolSize = {}",DATASOURCE_BEAN_NAME,dataSource.getMaximumPoolSize());
    	}else
    	{
    		log.error("Null {} Hikari Data Source",DATASOURCE_BEAN_NAME);
    	}
    	log.info("{}JPA Properties: {}",DATASOURCE_BEAN_NAME,(jpaProperties==null?null:jpaProperties.getProperties()));
    	LocalContainerEntityManagerFactoryBean emf = builder
                .dataSource(dataSource)
                .packages(Db01DataSourceConfig.class.getPackageName())
