...
@Slf4j
@Configuration
@EnableJpaRepositories(entityManagerFactoryRef = Db01DataSourceConfig.DATASOURCE_BEAN_NAME
		+ "EntityManagerFactory", transactionManagerRef = Db01DataSourceConfig.DATASOURCE_BEAN_NAME
				+ "TransactionManager")
